...
class Database:
    ...
    def get_points_geojson(self, limit=500):
        ...
        LEFT JOIN LATERAL (
            ...
            FROM protected_zones
            WHERE ST_Contains(protected_zones.geom, t.geom)
        ) z ON TRUE;
        """
        with self.conn.cursor() as cur:
    ...
    def save_violation_report(
        ...
        query = """
            ...
            (violation_type, violation_severity, people_count, detected_objects,
             confidence, raw_report, zone_name, protection_level, inside_geofence)
